...
{
    /// <inheritdoc />
    public partial class MigratebyLegendUdhay : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentOfferAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Negotiations_NegotiationId",
                        column: x => x.NegotiationId,
                        principalTable: "Negotiations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogisticsEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LogisticsEntries_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LogisticsEntries_Users_ProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogisticsEntries_OrderId",
                table: "LogisticsEntries",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_LogisticsEntries_ProviderId",
                table: "LogisticsEntries",
                column: "ProviderId");
