...
namespace Backend.Migrations
{
    ...
    [Migration("20251225090842_AddEmailVerificationTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Domain.BuyerLogisticsJob", b =>
                {
                    ...
                    b.Property<string>("DropLandmark")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ShipmentPriority")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Backend.Models.Domain.ChatThread", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Models.Domain.EmailVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Models.Domain.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Models.Domain.ChatMessage", b =>
                {
                    b.HasOne("Backend.Models.Domain.Offer", "Offer")
                        .WithMany()
                    ...
                    b.HasOne("Backend.Models.Domain.ChatThread", "Thread")
                        .WithMany("Messages")
