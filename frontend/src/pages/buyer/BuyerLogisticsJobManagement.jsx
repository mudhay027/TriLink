...
const BuyerLogisticsJobManagement = () => {
            ...
            <nav style={{ background: 'white', borderBottom: '1px solid var(--border)', padding: '1rem 3rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '3rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '2rem', fontSize: '0.95rem', fontWeight: '500' }}>
                        <a href="#" onClick={() => { const userId = localStorage.getItem('userId'); navigate(`/buyer/dashboard/${userId}`); }} style={{ color: 'var(--text-muted)', cursor: 'pointer', transition: 'color 0.2s' }}>Dashboard</a>
                        <a href="#" onClick={() => { const userId = localStorage.getItem('userId'); navigate(`/buyer/search/${userId}`); }} style={{ color: 'var(--text-muted)', cursor: 'pointer', transition: 'color 0.2s' }}>Search Products</a>
                        <a href="#" onClick={() => { const userId = localStorage.getItem('userId'); navigate(`/buyer/active-negotiations/${userId}`); }} style={{ color: 'var(--text-muted)', cursor: 'pointer', transition: 'color 0.2s' }}>Negotiation</a>
                        <a href="#" onClick={() => { const userId = localStorage.getItem('userId'); navigate(`/buyer/orders/${userId}`); }} style={{ color: 'var(--text-muted)', cursor: 'pointer', transition: 'color 0.2s' }}>Orders</a>
                ...
                <div style={{ marginBottom: '2.5rem' }}>
                    <button
                        onClick={() => {
                            ...
                            navigate(`/buyer/logistics-jobs/${userId}`);
                        }}
...
export default BuyerLogisticsJobManagement;
