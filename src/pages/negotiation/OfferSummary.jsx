...
const OfferSummary = () => {
    ...
    return (
        <div className="fade-in" style={{ minHeight: '100vh', background: '#f8fafc' }}>
            {/* Navigation Bar - Supplier Context */}
            ...
            <main className="container" style={{ padding: '3rem 1rem', maxWidth: '1000px', margin: '0 auto' }}>
                <div style={{ marginBottom: '2rem' }}>
                    <h1 style={{ fontSize: '1.75rem', fontWeight: '600', marginBottom: '0.5rem' }}>Offer Summary</h1>
                    <p style={{ color: 'var(--text-muted)' }}>Review the final agreed terms</p>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div className="card" style={{ padding: '1.5rem', display: 'flex', gap: '1.5rem' }}>
                        ...
                        <div>
                            <h3 style={{ fontSize: '1.1rem', fontWeight: '600', marginBottom: '0.25rem' }}>TMT Bars 16mm</h3>
                            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '1rem' }}>SKU: TMT-16-2025</p>
                            <div style={{ display: 'flex', gap: '1rem' }}>
                                <span style={{ background: '#f1f5f9', padding: '0.25rem 0.75rem', borderRadius: '4px', fontSize: '0.85rem' }}>Category: Steel</span>
                                <span style={{ background: '#f1f5f9', padding: '0.25rem 0.75rem', borderRadius: '4px', fontSize: '0.85rem' }}>Grade: Fe 550</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card" style={{ padding: '2rem' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '0.95rem' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <span style={{ fontWeight: '500' }}>₹43,500.00</span>
                            </div>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                <span style={{ color: 'var(--text-muted)' }}>Quantity</span>
                                <span style={{ fontWeight: '500' }}>100 tons</span>
                            </div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '1rem', borderTop: '1px dashed var(--border)' }}>
                                <span style={{ color: 'var(--text-muted)' }}>Subtotal</span>
                                <span style={{ fontWeight: '500' }}>₹43,50,000.00</span>
                            </div>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                <span style={{ color: 'var(--text-muted)' }}>Tax (18% GST)</span>
                                <span style={{ fontWeight: '500' }}>₹7,83,000.00</span>
                            </div>
                    ...
                    <div className="card" style={{ padding: '2rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', fontSize: '0.95rem' }}>
                            ...
                            <div>
                                ...
                                <div style={{ fontWeight: '500' }}>Heavy Freight</div>
                            </div>
                            <div style={{ textAlign: 'right' }}>
                                <div style={{ color: 'var(--text-muted)', marginBottom: '0.25rem' }}>Incoterms</div>
                                <div style={{ fontWeight: '500' }}>DAP</div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Buyer Info */}
                    <div className="card" style={{ padding: '2rem' }}>
                        <h3 style={{ fontSize: '1rem', fontWeight: '600', marginBottom: '1.5rem', borderBottom: '1px solid var(--border)', paddingBottom: '1rem' }}>Buyer Information</h3>
                        <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                            ...
                            <div>
                                <h4 style={{ fontWeight: '600', marginBottom: '0.25rem' }}>Skyline Infra</h4>
                                <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '1rem' }}>Verified Buyer</p>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}><MapPin size={16} /> Mumbai, India</div>
                                </div>
                            </div>
                        </div>
                    </div>
